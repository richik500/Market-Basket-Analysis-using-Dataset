...
# Tools Used
#R; RStudio; Excel / CSV; arules Package; arulesViz Package; dplyr; tidyr

# Techniques Used
#Data Cleaning: Removed missing / invalid item values (NONE); Converted item column into categorical format
#Exploratory Analysis: Summary of dataset; Item frequency counts; Top 10 most popular products
#Visualization: Bar Plot of Top Items; Association Rule Graph; Parallel Coordinate Plot
#Association Rule Mining: Used Apriori Algorithm with: Minimum Support = 0.01; Minimum Confidence = 0.50 Generated rules showing: Support, Confidence, Lift, Coverage, Count
...
#Product Placement: Place related products together (e.g., Coffee near Spanish Brunch).
#Cross Selling: Suggest complementary items during purchase.
#Upselling: Promote premium versions or combos.
#Customer Segmentation: Target customers who frequently buy certain combinations.
#Inventory Planning: Stock linked products together during peak demand periods.

# Skills Demonstrated
#Retail Analytics; Association Rule Mining; Customer Behavior Analysis; Business Strategy; Data Visualization; R Programming
